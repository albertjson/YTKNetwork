...
+ (void)configMockHttpResponse
{
    ...
    [OHHTTPStubs stubRequestsPassingTest:^BOOL(NSURLRequest * _Nonnull request) {
        ...
        if ([urlString containsString:@"iphone/users"]) {
            return YES;
        }
        //else if (<#expression#>){}
        return NO;
...
//            return [OHHTTPStubsResponse responseWithError:notConnectedError];
            ...
            return [[OHHTTPStubsResponse responseWithJSONObject:@{@"nick":@"http://m6.g13p.com/j0/girl13.com-2016-09-26-16-57-08_7h.jpg",@"level":@333} statusCode:statusCode headers:nil] requestTime:requestTime responseTime:responseTime];
        }
        //else if (<#expression#>){}
        return nil;
    }];
